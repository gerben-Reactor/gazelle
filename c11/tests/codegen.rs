...
const PASSING: &[&str] = &[
    ...
    "00036.c", "00037.c", "00038.c", "00039.c", "00040.c", "00041.c",
    ...
    "00085.c", "00086.c", "00087.c", "00088.c", "00090.c",
    "00094.c", "00095.c", "00096.c", "00097.c",
    ...
    "00123.c", "00125.c", "00126.c", "00127.c", "00128.c", "00130.c",
    "00131.c", "00133.c", "00134.c", "00135.c", "00136.c", "00139.c",
    "00140.c", "00141.c", "00142.c", "00144.c", "00145.c",
    "00146.c", "00151.c", "00152.c", "00153.c", "00154.c", "00155.c",
    "00156.c", "00157.c", "00159.c", "00160.c", "00161.c",
    "00162.c", "00163.c", "00164.c", "00165.c", "00166.c",
    "00167.c", "00168.c", "00169.c", "00171.c", "00172.c",
    "00173.c", "00176.c", "00178.c", "00180.c", "00181.c", "00183.c",
...
fn compile_and_run(c_path: &Path, run: bool) -> Result<(i32, String), String> {
...
fn test_codegen() {
    ...
    for entry in &entries {
        ...
        match compile_and_run(&entry.path(), expected_pass) {
